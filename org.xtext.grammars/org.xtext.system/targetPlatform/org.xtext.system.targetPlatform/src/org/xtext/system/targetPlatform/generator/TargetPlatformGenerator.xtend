...
//
//================================================================
package org.xtext.system.targetPlatform.generator
...
class TargetPlatformGenerator extends AbstractGenerator {
	...
	override void doGenerate(Resource resource, IFileSystemAccess2 fsa, IGeneratorContext context) {
		...
		val IConfigurationElement[] config = Platform.getExtensionRegistry().getConfigurationElementsFor("org.xtext.system.targetPlatform.TargetPlatformGeneratorEP")
		try {
			// for each extension
			for(ext: config) {
