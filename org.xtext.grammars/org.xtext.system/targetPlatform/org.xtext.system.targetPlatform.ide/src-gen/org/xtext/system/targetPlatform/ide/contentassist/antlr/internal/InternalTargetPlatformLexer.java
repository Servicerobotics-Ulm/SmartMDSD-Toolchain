...
public class InternalTargetPlatformLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3810:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalTargetPlatform.g:3810:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalTargetPlatform.g:3810:31: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalTargetPlatform.g:3810:59: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_ML_DOCUMENTATION() throws RecognitionException {
        try {
            // InternalTargetPlatform.g:3812:32: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalTargetPlatform.g:3812:34: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalTargetPlatform.g:3812:40: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalTargetPlatform.g:3812:68: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3814:17: ( '//' ~ ( '/' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalTargetPlatform.g:3814:19: '//' ~ ( '/' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 
            ...
            // InternalTargetPlatform.g:3814:31: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
            ...
            // InternalTargetPlatform.g:3814:47: ( ( '\\r' )? '\\n' )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalTargetPlatform.g:3814:48: ( '\\r' )? '\\n'
                    {
                    // InternalTargetPlatform.g:3814:48: ( '\\r' )?
                    int alt4=2;
    ...
    public final void mRULE_SL_DOCUMENTATION() throws RecognitionException {
        try {
            // InternalTargetPlatform.g:3816:32: ( '///' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalTargetPlatform.g:3816:34: '///' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("///"); 

            // InternalTargetPlatform.g:3816:40: (~ ( ( '\\n' | '\\r' ) ) )*
            loop6:
            do {
                int alt6=2;
            ...
            // InternalTargetPlatform.g:3816:56: ( ( '\\r' )? '\\n' )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalTargetPlatform.g:3816:57: ( '\\r' )? '\\n'
                    {
                    // InternalTargetPlatform.g:3816:57: ( '\\r' )?
                    int alt7=2;
    ...
    public final void mRULE_DOCU_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3818:19: ( ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION ) )
            // InternalTargetPlatform.g:3818:21: ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION )
            {
            // InternalTargetPlatform.g:3818:21: ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalTargetPlatform.g:3818:22: RULE_ML_DOCUMENTATION
                    {
                    ...
                    break;
                case 2 :
                    // InternalTargetPlatform.g:3818:44: RULE_SL_DOCUMENTATION
                    {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3820:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalTargetPlatform.g:3820:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalTargetPlatform.g:3820:11: ( '^' )?
            int alt10=2;
            ...
            // InternalTargetPlatform.g:3820:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3822:10: ( ( '0' .. '9' )+ )
            // InternalTargetPlatform.g:3822:12: ( '0' .. '9' )+
            {
            // InternalTargetPlatform.g:3822:12: ( '0' .. '9' )+
            int cnt12=0;
            loop12:
            do {
                ...
                switch (alt12) {
            	case 1 :
            	    // InternalTargetPlatform.g:3822:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3824:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalTargetPlatform.g:3824:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalTargetPlatform.g:3824:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalTargetPlatform.g:3824:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalTargetPlatform.g:3824:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop13:
                    do {
                        int alt13=3;
                        ...
                        switch (alt13) {
                    	case 1 :
                    	    // InternalTargetPlatform.g:3824:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalTargetPlatform.g:3824:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalTargetPlatform.g:3824:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalTargetPlatform.g:3824:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop14:
                    do {
                        int alt14=3;
                        ...
                        switch (alt14) {
                    	case 1 :
                    	    // InternalTargetPlatform.g:3824:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalTargetPlatform.g:3824:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3826:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalTargetPlatform.g:3826:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalTargetPlatform.g:3826:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetPlatform.g:3828:16: ( . )
            // InternalTargetPlatform.g:3828:18: .
            {
            matchAny(); 
