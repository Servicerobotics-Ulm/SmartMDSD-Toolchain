...
//
//================================================================
package org.xtext.system.systemDatasheet.ide.contentassist.antlr;
...
import org.xtext.system.systemDatasheet.ide.contentassist.antlr.internal.InternalSystemDatasheetParser;
import org.xtext.system.systemDatasheet.services.SystemDatasheetGrammarAccess;

public class SystemDatasheetParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(SystemDatasheetGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SystemDatasheetGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSystemDatasheetAccess().getGroup(), "rule__SystemDatasheet__Group__0");
			...
			builder.put(grammarAccess.getSystemDatasheetAccess().getNameAssignment_2(), "rule__SystemDatasheet__NameAssignment_2");
	...
	@Override
	protected InternalSystemDatasheetParser createParser() {
		InternalSystemDatasheetParser result = new InternalSystemDatasheetParser(null);
