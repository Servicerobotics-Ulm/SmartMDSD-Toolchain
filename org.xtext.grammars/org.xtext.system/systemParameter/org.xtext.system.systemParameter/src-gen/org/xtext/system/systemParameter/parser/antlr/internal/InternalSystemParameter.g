...
entryRuleSystemParamModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSystemParamModelRule()); }
	iv_ruleSystemParamModel=ruleSystemParamModel
	{ $current=$iv_ruleSystemParamModel.current; }
	EOF;

// Rule SystemParamModel
ruleSystemParamModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		otherlv_1='SystemParameterModel'
		{
...
entryRuleComponentParameterInstance returns [EObject current=null]:
	...
	{ $current=$iv_ruleComponentParameterInstance.current; }
	EOF;

// Rule ComponentParameterInstance
ruleComponentParameterInstance returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		otherlv_0='ComponentParameterInstance'
		{
...
entryRuleParameterRefinement returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getParameterRefinementRule()); }
	iv_ruleParameterRefinement=ruleParameterRefinement
	{ $current=$iv_ruleParameterRefinement.current; }
	EOF;

// Rule ParameterRefinement
ruleParameterRefinement returns [EObject current=null]
@init {
	enterRule();
}
@after {
