...
public class BasicAttributesSyntacticSequencer extends AbstractSyntacticSequencer {

	protected BasicAttributesGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (BasicAttributesGrammarAccess) access;
