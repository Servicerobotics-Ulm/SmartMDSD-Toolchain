...
public class InternalDocuTerminalsLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalDocuTerminals.g:161:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalDocuTerminals.g:161:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalDocuTerminals.g:161:31: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalDocuTerminals.g:161:59: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_ML_DOCUMENTATION() throws RecognitionException {
        try {
            // InternalDocuTerminals.g:163:32: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalDocuTerminals.g:163:34: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalDocuTerminals.g:163:40: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalDocuTerminals.g:163:68: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDocuTerminals.g:165:17: ( '//' ~ ( '/' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDocuTerminals.g:165:19: '//' ~ ( '/' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 
            ...
            // InternalDocuTerminals.g:165:31: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
            ...
            // InternalDocuTerminals.g:165:47: ( ( '\\r' )? '\\n' )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalDocuTerminals.g:165:48: ( '\\r' )? '\\n'
                    {
                    // InternalDocuTerminals.g:165:48: ( '\\r' )?
                    int alt4=2;
    ...
    public final void mRULE_SL_DOCUMENTATION() throws RecognitionException {
        try {
            // InternalDocuTerminals.g:167:32: ( '///' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDocuTerminals.g:167:34: '///' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("///"); 

            // InternalDocuTerminals.g:167:40: (~ ( ( '\\n' | '\\r' ) ) )*
            loop6:
            do {
                int alt6=2;
            ...
            // InternalDocuTerminals.g:167:56: ( ( '\\r' )? '\\n' )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalDocuTerminals.g:167:57: ( '\\r' )? '\\n'
                    {
                    // InternalDocuTerminals.g:167:57: ( '\\r' )?
                    int alt7=2;
    ...
    public final void mRULE_DOCU_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDocuTerminals.g:169:19: ( ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION ) )
            // InternalDocuTerminals.g:169:21: ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION )
            {
            // InternalDocuTerminals.g:169:21: ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalDocuTerminals.g:169:22: RULE_ML_DOCUMENTATION
                    {
                    ...
                    break;
                case 2 :
                    // InternalDocuTerminals.g:169:44: RULE_SL_DOCUMENTATION
                    {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDocuTerminals.g:171:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalDocuTerminals.g:171:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalDocuTerminals.g:171:11: ( '^' )?
            int alt10=2;
            ...
            // InternalDocuTerminals.g:171:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDocuTerminals.g:173:10: ( ( '0' .. '9' )+ )
            // InternalDocuTerminals.g:173:12: ( '0' .. '9' )+
            {
            // InternalDocuTerminals.g:173:12: ( '0' .. '9' )+
            int cnt12=0;
            loop12:
            do {
                ...
                switch (alt12) {
            	case 1 :
            	    // InternalDocuTerminals.g:173:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDocuTerminals.g:175:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalDocuTerminals.g:175:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalDocuTerminals.g:175:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalDocuTerminals.g:175:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalDocuTerminals.g:175:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop13:
                    do {
                        int alt13=3;
                        ...
                        switch (alt13) {
                    	case 1 :
                    	    // InternalDocuTerminals.g:175:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalDocuTerminals.g:175:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalDocuTerminals.g:175:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalDocuTerminals.g:175:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop14:
                    do {
                        int alt14=3;
                        ...
                        switch (alt14) {
                    	case 1 :
                    	    // InternalDocuTerminals.g:175:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalDocuTerminals.g:175:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDocuTerminals.g:177:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalDocuTerminals.g:177:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalDocuTerminals.g:177:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDocuTerminals.g:179:16: ( . )
            // InternalDocuTerminals.g:179:18: .
            {
            matchAny(); 
