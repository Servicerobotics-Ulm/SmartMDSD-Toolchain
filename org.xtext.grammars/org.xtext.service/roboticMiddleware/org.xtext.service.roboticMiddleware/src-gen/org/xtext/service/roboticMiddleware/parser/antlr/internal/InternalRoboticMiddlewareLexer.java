...
public class InternalRoboticMiddlewareLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:416:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalRoboticMiddleware.g:416:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalRoboticMiddleware.g:416:31: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalRoboticMiddleware.g:416:59: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_ML_DOCUMENTATION() throws RecognitionException {
        try {
            // InternalRoboticMiddleware.g:418:32: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalRoboticMiddleware.g:418:34: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalRoboticMiddleware.g:418:40: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalRoboticMiddleware.g:418:68: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:420:17: ( '//' ~ ( '/' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRoboticMiddleware.g:420:19: '//' ~ ( '/' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 
            ...
            // InternalRoboticMiddleware.g:420:31: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
            ...
            // InternalRoboticMiddleware.g:420:47: ( ( '\\r' )? '\\n' )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalRoboticMiddleware.g:420:48: ( '\\r' )? '\\n'
                    {
                    // InternalRoboticMiddleware.g:420:48: ( '\\r' )?
                    int alt4=2;
    ...
    public final void mRULE_SL_DOCUMENTATION() throws RecognitionException {
        try {
            // InternalRoboticMiddleware.g:422:32: ( '///' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRoboticMiddleware.g:422:34: '///' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("///"); 

            // InternalRoboticMiddleware.g:422:40: (~ ( ( '\\n' | '\\r' ) ) )*
            loop6:
            do {
                int alt6=2;
            ...
            // InternalRoboticMiddleware.g:422:56: ( ( '\\r' )? '\\n' )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalRoboticMiddleware.g:422:57: ( '\\r' )? '\\n'
                    {
                    // InternalRoboticMiddleware.g:422:57: ( '\\r' )?
                    int alt7=2;
    ...
    public final void mRULE_DOCU_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:424:19: ( ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION ) )
            // InternalRoboticMiddleware.g:424:21: ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION )
            {
            // InternalRoboticMiddleware.g:424:21: ( RULE_ML_DOCUMENTATION | RULE_SL_DOCUMENTATION )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalRoboticMiddleware.g:424:22: RULE_ML_DOCUMENTATION
                    {
                    ...
                    break;
                case 2 :
                    // InternalRoboticMiddleware.g:424:44: RULE_SL_DOCUMENTATION
                    {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:426:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRoboticMiddleware.g:426:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRoboticMiddleware.g:426:11: ( '^' )?
            int alt10=2;
            ...
            // InternalRoboticMiddleware.g:426:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:428:10: ( ( '0' .. '9' )+ )
            // InternalRoboticMiddleware.g:428:12: ( '0' .. '9' )+
            {
            // InternalRoboticMiddleware.g:428:12: ( '0' .. '9' )+
            int cnt12=0;
            loop12:
            do {
                ...
                switch (alt12) {
            	case 1 :
            	    // InternalRoboticMiddleware.g:428:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:430:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRoboticMiddleware.g:430:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRoboticMiddleware.g:430:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalRoboticMiddleware.g:430:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRoboticMiddleware.g:430:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop13:
                    do {
                        int alt13=3;
                        ...
                        switch (alt13) {
                    	case 1 :
                    	    // InternalRoboticMiddleware.g:430:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalRoboticMiddleware.g:430:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalRoboticMiddleware.g:430:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRoboticMiddleware.g:430:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop14:
                    do {
                        int alt14=3;
                        ...
                        switch (alt14) {
                    	case 1 :
                    	    // InternalRoboticMiddleware.g:430:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalRoboticMiddleware.g:430:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:432:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRoboticMiddleware.g:432:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRoboticMiddleware.g:432:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRoboticMiddleware.g:434:16: ( . )
            // InternalRoboticMiddleware.g:434:18: .
            {
            matchAny(); 
