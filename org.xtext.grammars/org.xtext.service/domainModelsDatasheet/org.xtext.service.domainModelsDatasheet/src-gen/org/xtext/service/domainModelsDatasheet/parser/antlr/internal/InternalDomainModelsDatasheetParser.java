...
public class InternalDomainModelsDatasheetParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_TEXT_BLOCK", "RULE_STRING", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'DomainModelsDatasheet'", "'{'", "'}'", "'baseURI'", "':'", "'shortDescription'", "'longDescription'", "'supplierDescription'", "'homepage'", "'trl'", "'license'", "'spdx'", "'('", "')'", "'proprietary'", "'name'", "'fullText'", "'URL'", "'Level1'", "'Level2'", "'Level3'", "'Level4'", "'Level5'", "'Level6'", "'Level7'", "'Level8'", "'Level9'", "'Undefined'"
    };
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // InternalDomainModelsDatasheet.g:221:3: ({...}? => ( ({...}? => (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) ) ) ) )
            	    {
            	    // InternalDomainModelsDatasheet.g:221:3: ({...}? => ( ({...}? => (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) ) ) ) )
            	    // InternalDomainModelsDatasheet.g:222:4: {...}? => ( ({...}? => (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) ) ) )
            	    {
            	    ...
            	    // InternalDomainModelsDatasheet.g:222:110: ( ({...}? => (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) ) ) )
            	    // InternalDomainModelsDatasheet.g:223:5: ({...}? => (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) ) )
            	    {

            	    					getUnorderedGroupHelper().select(grammarAccess.getGenericDatasheetAccess().getUnorderedGroup(), 1);
            	    				
            	    // InternalDomainModelsDatasheet.g:226:8: ({...}? => (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) ) )
            	    // InternalDomainModelsDatasheet.g:226:9: {...}? => (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) )
            	    {
            	    if ( !((true)) ) {
            	        throw new FailedPredicateException(input, "ruleGenericDatasheet", "true");
            	    }
            	    // InternalDomainModelsDatasheet.g:226:18: (otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) ) )
            	    // InternalDomainModelsDatasheet.g:226:19: otherlv_4= 'shortDescription' (otherlv_5= ':' )? ( (lv_shortDescription_6_0= ruleEString ) )
            	    {
            	    ...
            	    // InternalDomainModelsDatasheet.g:236:8: ( (lv_shortDescription_6_0= ruleEString ) )
            	    // InternalDomainModelsDatasheet.g:237:9: (lv_shortDescription_6_0= ruleEString )
            	    {
            	    // InternalDomainModelsDatasheet.g:237:9: (lv_shortDescription_6_0= ruleEString )
            	    // InternalDomainModelsDatasheet.g:238:10: lv_shortDescription_6_0= ruleEString
            	    {
