...
entryRuleSkillDefinitionModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSkillDefinitionModelRule()); }
	iv_ruleSkillDefinitionModel=ruleSkillDefinitionModel
	{ $current=$iv_ruleSkillDefinitionModel.current; }
	EOF;

// Rule SkillDefinitionModel
ruleSkillDefinitionModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSkillDefinitionRepository returns [EObject current=null]:
	...
	{ $current=$iv_ruleSkillDefinitionRepository.current; }
	EOF;

// Rule SkillDefinitionRepository
ruleSkillDefinitionRepository returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		otherlv_0='SkillDefinitionRepository'
		{
...
entryRuleSkillResult returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSkillResultRule()); }
	iv_ruleSkillResult=ruleSkillResult
	{ $current=$iv_ruleSkillResult.current; }
	EOF;

// Rule SkillResult
ruleSkillResult returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
ruleSKILL_RESULT_TYPES returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
