...
public class InternalServiceDefinitionLexer extends Lexer {
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:29:7: ( 'with' )
            // InternalServiceDefinition.g:29:9: 'with'
            {
            match("with"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:1854:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalServiceDefinition.g:1854:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalServiceDefinition.g:1854:11: ( '^' )?
            int alt1=2;
            ...
            // InternalServiceDefinition.g:1854:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:1856:10: ( ( '0' .. '9' )+ )
            // InternalServiceDefinition.g:1856:12: ( '0' .. '9' )+
            {
            // InternalServiceDefinition.g:1856:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalServiceDefinition.g:1856:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:1858:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalServiceDefinition.g:1858:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalServiceDefinition.g:1858:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalServiceDefinition.g:1858:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalServiceDefinition.g:1858:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalServiceDefinition.g:1858:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalServiceDefinition.g:1858:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalServiceDefinition.g:1858:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalServiceDefinition.g:1858:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalServiceDefinition.g:1858:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalServiceDefinition.g:1858:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:1860:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalServiceDefinition.g:1860:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalServiceDefinition.g:1860:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalServiceDefinition.g:1860:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:1862:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalServiceDefinition.g:1862:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalServiceDefinition.g:1862:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalServiceDefinition.g:1862:40: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalServiceDefinition.g:1862:41: ( '\\r' )? '\\n'
                    {
                    // InternalServiceDefinition.g:1862:41: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:1864:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalServiceDefinition.g:1864:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalServiceDefinition.g:1864:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDefinition.g:1866:16: ( . )
            // InternalServiceDefinition.g:1866:18: .
            {
            matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt12) {
            ...
            case 35 :
                ...
                break;
            case 36 :
                // InternalServiceDefinition.g:1:220: RULE_ID
                {
                mRULE_ID(); 
                ...
                break;
            case 37 :
                // InternalServiceDefinition.g:1:228: RULE_INT
                {
                mRULE_INT(); 
                ...
                break;
            case 38 :
                // InternalServiceDefinition.g:1:237: RULE_STRING
                {
                mRULE_STRING(); 
                ...
                break;
            case 39 :
                // InternalServiceDefinition.g:1:249: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
                ...
                break;
            case 40 :
                // InternalServiceDefinition.g:1:265: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
                ...
                break;
            case 41 :
                // InternalServiceDefinition.g:1:281: RULE_WS
                {
                mRULE_WS(); 
                ...
                break;
            case 42 :
                // InternalServiceDefinition.g:1:289: RULE_ANY_OTHER
                {
                mRULE_ANY_OTHER(); 
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 2 : 
                        ...
                        else if ( (LA12_0=='B'||(LA12_0>='G' && LA12_0<='I')||(LA12_0>='K' && LA12_0<='L')||(LA12_0>='N' && LA12_0<='O')||(LA12_0>='T' && LA12_0<='Z')||LA12_0=='_'||(LA12_0>='a' && LA12_0<='k')||(LA12_0>='m' && LA12_0<='t')||(LA12_0>='x' && LA12_0<='z')) ) {s = 26;}
