...
public class CommunicationObjectSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_CommObjectsRepository_SemicolonKeyword_5_2_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_CommObjectsRepository_SemicolonKeyword_5_2_q = new TokenAlias(false, true, grammarAccess.getCommObjectsRepositoryAccess().getSemicolonKeyword_5_2());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_CommObjectsRepository_SemicolonKeyword_5_2_q.equals(syntax))
				emit_CommObjectsRepository_SemicolonKeyword_5_2_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_CommObjectsRepository_SemicolonKeyword_5_2_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
