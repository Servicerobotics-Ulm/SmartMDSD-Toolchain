...
public class ComponentParameterSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_TriggerInstance_SemicolonKeyword_4_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_TriggerInstance_SemicolonKeyword_4_q = new TokenAlias(false, true, grammarAccess.getTriggerInstanceAccess().getSemicolonKeyword_4());
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_TriggerInstance_SemicolonKeyword_4_q.equals(syntax))
				emit_TriggerInstance_SemicolonKeyword_4_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_TriggerInstance_SemicolonKeyword_4_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
