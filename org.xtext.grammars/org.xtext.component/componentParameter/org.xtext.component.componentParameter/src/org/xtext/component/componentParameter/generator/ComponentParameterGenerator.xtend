...
//
//================================================================
package org.xtext.component.componentParameter.generator
...
class ComponentParameterGenerator extends AbstractGenerator {
	...
	override void doGenerate(Resource resource, IFileSystemAccess2 fsa, IGeneratorContext context) {
		...
		val IConfigurationElement[] config = Platform.getExtensionRegistry().getConfigurationElementsFor("org.xtext.component.componentParameter.ComponentParameterGeneratorEP")
		try {
			// for each extension
			for(ext: config) {
