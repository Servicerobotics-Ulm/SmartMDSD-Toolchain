...
//
//================================================================
package org.xtext.component.componentDefinition.generator
...
class ComponentDefinitionGenerator extends AbstractGenerator {
	...
	override void doGenerate(Resource resource, IFileSystemAccess2 fsa, IGeneratorContext context) {
		...
		val IConfigurationElement[] config = Platform.getExtensionRegistry().getConfigurationElementsFor("org.xtext.component.componentDefinition.ComponentDefinitionGeneratorEP")
		try {
			// for each extension
			for(ext: config) {
