/**
 */
package org.ecore.base.documentation.util;
 ...
 * <!-- end-user-doc -->
 * @see org.ecore.base.documentation.DocumentationPackage
 * @generated
 */
public class DocumentationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DocumentationPackage.ABSTRACT_DOCUMENTED_ELEMENT: {
			AbstractDocumentedElement abstractDocumentedElement = (AbstractDocumentedElement) theEObject;
			T result = caseAbstractDocumentedElement(abstractDocumentedElement);
			if (result == null)
