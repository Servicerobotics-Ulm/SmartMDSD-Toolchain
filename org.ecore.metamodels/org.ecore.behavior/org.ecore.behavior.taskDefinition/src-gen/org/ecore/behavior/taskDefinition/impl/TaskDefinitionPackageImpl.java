...
public class TaskDefinitionPackageImpl extends EPackageImpl implements TaskDefinitionPackage {
	 ...
	 * @see org.ecore.behavior.taskDefinition.TaskDefinitionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static TaskDefinitionPackage init() {
		...
		TaskDefinitionPackageImpl theTaskDefinitionPackage = (TaskDefinitionPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof TaskDefinitionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEEnum(tasK_RESULT_TYPESEEnum, org.ecore.behavior.taskDefinition.TASK_RESULT_TYPES.class,
				"TASK_RESULT_TYPES");
		addEEnumLiteral(tasK_RESULT_TYPESEEnum, org.ecore.behavior.taskDefinition.TASK_RESULT_TYPES.SUCCESS);
		addEEnumLiteral(tasK_RESULT_TYPESEEnum, org.ecore.behavior.taskDefinition.TASK_RESULT_TYPES.ERROR);
