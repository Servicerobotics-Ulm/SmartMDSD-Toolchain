/**
 */
package org.ecore.system.compArchSeronetExtension.util;
...
public class CompArchSeronetExtensionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CompArchSeronetExtensionPackage.OPC_UA_DEVICE_CLIENT_INSTANCE: {
			OpcUaDeviceClientInstance opcUaDeviceClientInstance = (OpcUaDeviceClientInstance) theEObject;
			T result = caseOpcUaDeviceClientInstance(opcUaDeviceClientInstance);
			if (result == null)
				result = caseComponentInstanceExtension(opcUaDeviceClientInstance);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Opc Ua Device Client Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Opc Ua Device Client Instance</em>'.
...
} //CompArchSeronetExtensionSwitch
