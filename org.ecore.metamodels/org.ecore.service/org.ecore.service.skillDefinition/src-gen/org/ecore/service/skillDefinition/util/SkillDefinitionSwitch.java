...
public class SkillDefinitionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SkillDefinitionPackage.SKILL_DEFINITION_MODEL: {
			SkillDefinitionModel skillDefinitionModel = (SkillDefinitionModel) theEObject;
			T result = caseSkillDefinitionModel(skillDefinitionModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SkillDefinitionPackage.SKILL_DEFINITION_REPOSITORY: {
			SkillDefinitionRepository skillDefinitionRepository = (SkillDefinitionRepository) theEObject;
			T result = caseSkillDefinitionRepository(skillDefinitionRepository);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseSkillDefinitionModel(SkillDefinitionModel object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSkillDefinitionRepository(SkillDefinitionRepository object) {
		return null;
	}
