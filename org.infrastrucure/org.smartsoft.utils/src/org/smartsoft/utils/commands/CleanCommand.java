...
public class CleanCommand extends AbstractBuildCommand {

	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		String commandName = "MakeDistclean";
//		System.out.println("execute "+commandName);
		...
		if(currentProject != null) {
			...
			//FIXME: activate the "distclean" target in CMake and use the commented out "distclean" target again
			//final String cmakeParams = "distclean";
			final String cmakeParams = "clean";
