...
public class CMakeCommand extends AbstractBuildCommand {
	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		String commandName = "CMake";
//		System.out.println("execute "+commandName);
		...
		if(currentProject != null) {
			...
			final String cmakeCommand = Activator.getDefault().getPreferenceStore().getString("CMakeCommand");
			final String cmakeParams = "..";
