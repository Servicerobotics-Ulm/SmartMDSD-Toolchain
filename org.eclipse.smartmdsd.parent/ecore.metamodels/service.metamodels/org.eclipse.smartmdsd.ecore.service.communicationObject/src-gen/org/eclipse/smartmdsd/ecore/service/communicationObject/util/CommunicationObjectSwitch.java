...
public class CommunicationObjectSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CommunicationObjectPackage.COMM_OBJECTS_REPOSITORY: {
			...
			if (result == null)
				result = caseAbstractDocumentationElement(commObjectsRepository);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CommunicationObjectPackage.ABSTRACT_COMM_ELEMENT: {
			...
			if (result == null)
				result = caseAbstractDocumentationElement(abstractCommElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CommunicationObjectPackage.ENUMERATION: {
			...
			if (result == null)
				result = caseAbstractDocumentationElement(enumeration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CommunicationObjectPackage.COMMUNICATION_OBJECT: {
			...
			if (result == null)
				result = caseAbstractDocumentationElement(communicationObject);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
