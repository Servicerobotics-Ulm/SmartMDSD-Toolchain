 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.smartmdsd.ecore.service.communicationObject.impl.CommunicationObjectImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationObjectImpl extends AbstractCommElementImpl implements CommunicationObject {
	/**
	...
	protected EClass eStaticClass() {
		return CommunicationObjectPackage.Literals.COMMUNICATION_OBJECT;
	}
	...
	public EList<AttributeDefinition> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeDefinition>(AttributeDefinition.class, this,
					CommunicationObjectPackage.COMMUNICATION_OBJECT__ATTRIBUTES);
		}
		return attributes;
	}
