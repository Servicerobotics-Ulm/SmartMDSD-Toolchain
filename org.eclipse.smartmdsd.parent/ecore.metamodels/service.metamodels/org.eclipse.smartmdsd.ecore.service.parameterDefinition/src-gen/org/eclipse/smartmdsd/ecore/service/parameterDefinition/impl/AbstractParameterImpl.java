 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.smartmdsd.ecore.service.parameterDefinition.impl.AbstractParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.smartmdsd.ecore.service.parameterDefinition.impl.AbstractParameterImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractParameterImpl extends AbstractDocumentationElementImpl implements AbstractParameter {
	/**
	...
	protected EClass eStaticClass() {
		return ParameterDefinitionPackage.Literals.ABSTRACT_PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParameterDefinitionPackage.ABSTRACT_PARAMETER__NAME,
					oldName, name));
	}
	...
	public EList<AttributeDefinition> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeDefinition>(AttributeDefinition.class, this,
					ParameterDefinitionPackage.ABSTRACT_PARAMETER__ATTRIBUTES);
		}
		return attributes;
	}
