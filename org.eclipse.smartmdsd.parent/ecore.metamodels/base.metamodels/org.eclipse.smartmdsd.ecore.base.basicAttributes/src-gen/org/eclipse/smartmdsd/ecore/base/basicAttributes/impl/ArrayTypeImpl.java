 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.smartmdsd.ecore.base.basicAttributes.impl.ArrayTypeImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayTypeImpl extends MinimalEObjectImpl.Container implements ArrayType {
	...
	protected EClass eStaticClass() {
		return BasicAttributesPackage.Literals.ARRAY_TYPE;
	}
	...
	public void setLength(String newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicAttributesPackage.ARRAY_TYPE__LENGTH, oldLength,
					length));
	}
