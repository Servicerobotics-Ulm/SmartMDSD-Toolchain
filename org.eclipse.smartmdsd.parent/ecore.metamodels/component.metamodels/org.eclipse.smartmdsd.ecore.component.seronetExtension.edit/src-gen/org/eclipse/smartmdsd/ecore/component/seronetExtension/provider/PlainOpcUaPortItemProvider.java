...
import org.eclipse.smartmdsd.ecore.component.componentDefinition.provider.AbstractComponentElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.smartmdsd.ecore.component.seronetExtension.PlainOpcUaPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlainOpcUaPortItemProvider extends AbstractComponentElementItemProvider {
	 ...
	 * @generated
	 */
	public PlainOpcUaPortItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((PlainOpcUaPort) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_PlainOpcUaPort_type")
				: getString("_UI_PlainOpcUaPort_type") + " " + label;
	}
