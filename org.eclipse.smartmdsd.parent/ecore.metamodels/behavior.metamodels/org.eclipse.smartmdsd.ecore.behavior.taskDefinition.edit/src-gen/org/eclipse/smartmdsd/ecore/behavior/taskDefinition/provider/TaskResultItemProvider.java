...
/**
 * This is the item provider adapter for a {@link org.eclipse.smartmdsd.ecore.behavior.taskDefinition.TaskResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskResultItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addResultPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TaskResult_result_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TaskResult_result_feature",
								"_UI_TaskResult_type"),
						TaskDefinitionPackage.Literals.TASK_RESULT__RESULT, true, false, false,
	...
	protected void addResultValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TaskResult_resultValue_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TaskResult_resultValue_feature",
								"_UI_TaskResult_type"),
						TaskDefinitionPackage.Literals.TASK_RESULT__RESULT_VALUE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		TASK_RESULT_TYPES labelValue = ((TaskResult) object).getResult();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_TaskResult_type")
