...
public class TaskDefinitionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TaskDefinitionPackage.TASK_DEFINITION_MODEL: {
			TaskDefinitionModel taskDefinitionModel = (TaskDefinitionModel) theEObject;
			T result = caseTaskDefinitionModel(taskDefinitionModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TaskDefinitionPackage.TASK_DEFINITION_REPOSITORY: {
			TaskDefinitionRepository taskDefinitionRepository = (TaskDefinitionRepository) theEObject;
			T result = caseTaskDefinitionRepository(taskDefinitionRepository);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseTaskDefinitionModel(TaskDefinitionModel object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseTaskDefinitionRepository(TaskDefinitionRepository object) {
		return null;
	}
